...
/**
 * Checks that {@link SafeSchemaFactory#newInstance(String)} passes the schema language through to {@link javax.xml.validation.SchemaFactory#newInstance}.
 *
...
class SchemaFactoryLanguageTest {
    ...
    void unknownSchemaLanguageThrows() {
        assertThrows(IllegalArgumentException.class, () -> SafeSchemaFactory.newInstance("urn:example:unknown-schema-language"),
