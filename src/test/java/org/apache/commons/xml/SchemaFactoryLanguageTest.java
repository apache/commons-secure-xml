...
/**
 * Checks that {@link XmlFactories#newSchemaFactory(String)} passes the schema language through to {@link javax.xml.validation.SchemaFactory#newInstance}.
 *
...
class SchemaFactoryLanguageTest {
    ...
    void unknownSchemaLanguageThrows() {
        assertThrows(IllegalArgumentException.class, () -> XmlFactories.newSchemaFactory("urn:example:unknown-schema-language"),
