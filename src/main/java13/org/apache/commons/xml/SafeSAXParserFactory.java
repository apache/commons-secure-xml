...
public final class SafeSAXParserFactory {
    ...
    /**
     * Returns a new, hardened {@link SAXParserFactory} of the system-default implementation, obtained as by {@link SAXParserFactory#newDefaultInstance()}.
     *
     * @return A hardened factory.
     * @throws IllegalStateException Thrown if a required hardening setting cannot be applied to the underlying implementation.
     */
    public static SAXParserFactory newDefaultInstance() {
        return SAXParserHardener.harden(SAXParserFactory.newDefaultInstance());
    }

    /**
     * Returns a new, hardened, namespace-aware {@link SAXParserFactory} of the system-default implementation, obtained as by
     * {@link SAXParserFactory#newDefaultNSInstance()}.
     *
     * @return A hardened, namespace-aware factory.
     * @throws IllegalStateException Thrown if a required hardening setting cannot be applied to the underlying implementation.
     */
    public static SAXParserFactory newDefaultNSInstance() {
        return SAXParserHardener.harden(SAXParserFactory.newDefaultNSInstance());
    }

    /**
     * Returns a new, hardened, namespace-aware {@link SAXParserFactory}, obtained as by {@link SAXParserFactory#newNSInstance()}.
     *
     * @return A hardened, namespace-aware factory.
     * @throws IllegalStateException     Thrown if a required hardening setting cannot be applied to the underlying implementation.
     * @throws FactoryConfigurationError Thrown from {@link SAXParserFactory} in case of a {@link java.util.ServiceConfigurationError service configuration
    ...
    public static SAXParserFactory newNSInstance() {
        return SAXParserHardener.harden(SAXParserFactory.newNSInstance());
    }

    /**
     * Returns a new, hardened, namespace-aware {@link SAXParserFactory} of the given implementation class, obtained as by
     * {@link SAXParserFactory#newNSInstance(String, ClassLoader)}.
     *
     * @param factoryClassName The fully qualified class name of the {@link SAXParserFactory} implementation.
     * @param classLoader      The class loader used to load the factory class; {@code null} means the current thread's context class loader.
     * @return A hardened, namespace-aware factory.
    ...
    public static SAXParserFactory newNSInstance(final String factoryClassName, final ClassLoader classLoader) {
        return SAXParserHardener.harden(SAXParserFactory.newNSInstance(factoryClassName, classLoader));
    }
