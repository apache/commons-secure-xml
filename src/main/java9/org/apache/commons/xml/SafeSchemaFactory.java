...
public final class SafeSchemaFactory {
    ...
    /**
     * Returns a new, hardened {@link SchemaFactory} of the system-default implementation, supporting W3C XML Schema 1.0, obtained as by
     * {@link SchemaFactory#newDefaultInstance()}.
     *
     * @return A hardened factory.
    ...
    public static SchemaFactory newDefaultInstance() {
        return SchemaHardener.harden(SchemaFactory.newDefaultInstance());
    }
