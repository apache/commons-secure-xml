 ...
 *
 * <p>
 * The floor is installed once and stays the reader's entity resolver for the wrapper's lifetime; {@link #setEntityResolver(EntityResolver)} routes the
 ...
 * reader's entity resolver, which would otherwise silently replace the floor. {@link #getEntityResolver()} reports the caller's resolver unwrapped.
 * </p>
 *
 * <p>
 * Every other method forwards to the wrapped delegate; subclasses (e.g., {@code SecureExpatXMLReader}) add per-implementation fixups on top of the
 * floor.
 * </p>
 */
